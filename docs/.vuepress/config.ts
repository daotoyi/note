...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  // base: '/site/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/more/',
        items: [
            {text: '收藏资源', link: '/pages/beb6c0bd8a66cea6/',
             // items: [
    ...
    author: {
      name: 'daotoyi', // 必需
      link: 'https://github.com/daotoyi/site', // 可选的
    },
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/tea.ico' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
